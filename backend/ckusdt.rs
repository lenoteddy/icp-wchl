...
impl Service {
    ...
    pub async fn icrc_103_get_allowances(&self, arg0: GetAllowancesArgs) -> Result<(Result_,)> {
        ic_cdk::call(self.0, "icrc103_get_allowances", (arg0,)).await
    }
    pub async fn icrc_106_get_index_principal(&self) -> Result<(Result1,)> {
    ...
    pub async fn icrc_1_transfer(&self, arg0: TransferArg) -> Result<(Result2,)> {
    ...
    pub async fn icrc_2_approve(&self, arg0: ApproveArgs) -> Result<(Result4,)> {
        ic_cdk::call(self.0, "icrc2_approve", (arg0,)).await
    }
    pub async fn icrc_2_transfer_from(&self, arg0: TransferFromArgs) -> Result<(Result5,)> {
